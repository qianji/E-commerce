...
<title>${message("admin.supplierAttribute.add")}</title>
...
$().ready(function() {
	...
	$type.change(function() {
		if ($type.val() == "select" || $type.val() == "checkbox") {
			$supplierAttributeTable.find("tr.optionTr").remove();
			$addOptionTr.show();
			addOption();
		} else {
			$addOptionTr.hide();
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.supplierAttribute.add")}
	</div>
	<form id="inputForm" action="save.jhtml" method="post">
		<table id="supplierAttributeTable" class="input">
			...
			<tr>
				<th>
					${message("SupplierAttribute.type")}:
				</th>
				<td>
					<select id="type" name="type">
						<option value="text">${message("SupplierAttribute.Type.text")}</option>
						<option value="select">${message("SupplierAttribute.Type.select")}</option>
						<option value="checkbox">${message("SupplierAttribute.Type.checkbox")}</option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="isEnabled" value="true" checked="checked" />${message("SupplierAttribute.isEnabled")}
						<input type="hidden" name="_isEnabled" value="false" />
					</label>
					<label>
						<input type="checkbox" name="isRequired" value="true" />${message("SupplierAttribute.isRequired")}
