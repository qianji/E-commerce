...
<body>
	...
	<form id="listForm" action="list_admin.jhtml" method="get">
		<div class="bar">
		...
		<table id="listTable" class="list">
			...
			[#list page.content as admin]
				<tr>
					...
					<td>
					    <a href="view_supplier_admin.jhtml?id=${admin.id}">[${message("admin.common.view")}]</a>
						<a href="edit_supplier_admin.jhtml?id=${admin.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
