...
import gov.guilin.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/guilin/template[@id='productContent']");
	 ...
	 */
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinTable(name="xc_product_supplier_b"	,
