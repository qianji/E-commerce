					...
					<form id="registerForm" action="${base}/register/submit.jhtml" method="post">
						<table>
							<tr>
								...
								<td>
									<input type="text" id="username" name="username" class="form-control" style="width:230px" maxlength="${setting.usernameMaxLength}" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password" name="password" class="form-control" style="width:230px" maxlength="${setting.passwordMaxLength}" autocomplete="off" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" name="rePassword" class="form-control" style="width:230px" maxlength="${setting.passwordMaxLength}" autocomplete="off" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" id="email" name="email" class="form-control" style="width:230px" maxlength="200" />
								</td>
							</tr>
							[@member_attribute_list]
								[#list memberAttributes as memberAttribute]
							...
							[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("memberRegister")]
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="form-control captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="${base}/common/captcha.jhtml?captchaId=${captchaId}" title="${message("shop.captcha.imageTitle")}" />
										</span>
									</td>
								</tr>
							[/#if]
							<tr>
								...
								<td>
									<input type="submit" class="btn btn-lg btn-primary" value="${message("shop.register.submit")}" />
								</td>
							</tr>
							<tr>
								<th>
