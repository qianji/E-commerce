...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.youguilin.com.cn/" target="_blank">http://www.youguilin.com.cn/</a>
			</td>
			<th>
				${message("admin.index.mail")}:
			</th>
			<td>
				<a href="mailto:service@youguilin.com.cn" target="_blank">service@youguilin.com.cn</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
