...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<ul id="tab" class="tab">
			...
			[#if admin.suppliers?has_content]
				<li>
					<input type="button" value="${message("admin.main.supplierAdmin")}" />
				</li>
			[/#if]
		</ul>
		<table class="input tabContent">
			...
			<tr class="roles">
				...
				<td>
					<span class="fieldSet">
						[#list roles as role]
							<label>
								<input type="checkbox" name="roleIds" value="${role.id}"[#if admin.roles?seq_contains(role)] checked="checked"[/#if] readonly />${role.name}
							</label>
						[/#list]
					</span>
				</td>
			...
			<tr>
				...
				<td>
					...
					[#if admin.isLocked]
						<label>
							<input type="checkbox" name="isLocked" value="true" checked="checked" readonly />${message("Admin.isLocked")}
						</label>
					[/#if]
				</td>
			</tr>
		...
		[#if admin.suppliers?has_content]
			<table class="input tabContent" id="supplierAttributeTable" >
					...
					[#list admin.suppliers as supplier]
						<tr class="optionTr">
							<th>${message("SupplierAdmin.message")}:</th>
							<td>
