...
<%
	...
	boolean isguilinXmlCanWrite = isCanWrite(rootPath + "/WEB-INF/classes/guilin.xml");
	boolean isguilinPropertiesWrite = isCanWrite(rootPath + "/WEB-INF/classes/guilin.properties");
	...
	String isguilinXmlCanWriteInfo = null;
	if (isguilinXmlCanWrite) {
		isguilinXmlCanWriteInfo = "<span class=\"green\">√</span>";
	} else {
		isguilinXmlCanWriteInfo = "<span class=\"red\">×</span>";
	}
	String isguilinPropertiesInfo = null;
	if (isguilinPropertiesWrite) {
		isguilinPropertiesInfo = "<span class=\"green\">√</span>";
	} else {
		isguilinPropertiesInfo = "<span class=\"red\">×</span>";
	}
...
$().ready( function() {
	...
	<%if ((freeSpace != 0 && freeSpace < 51200) || (maxMemory != 0 && maxMemory < 128) || !isguilinXmlCanWrite || !isguilinPropertiesWrite || !isWebXmlCanWrite || !isUploadCanWrite) { %>
		hasWarn = true;
	<% } %>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/guilin.xml
					</td>
					<td>
						可写
					</td>
					<td>
						<%=isguilinXmlCanWriteInfo%>
					</td>
				</tr>
				<tr>
					<td>
						/WEB-INF/classes/guilin.properties
					</td>
					<td>
						可写
					</td>
					<td>
						<%=isguilinPropertiesInfo%>
					</td>
				</tr>
				<tr>
					<td>
