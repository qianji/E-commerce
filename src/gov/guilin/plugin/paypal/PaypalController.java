 ...
 * License: guilin
 */
package gov.guilin.plugin.paypal;

import gov.guilin.Message;
import gov.guilin.controller.admin.BaseController;
import gov.guilin.entity.PluginConfig;
import gov.guilin.plugin.PaymentPlugin;
import gov.guilin.plugin.PaymentPlugin.FeeType;
import gov.guilin.plugin.paypal.PaypalPlugin.Currency;
import gov.guilin.service.PluginConfigService;
...
public class PaypalController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/gov/guilin/plugin/paypal/setting";
	}
