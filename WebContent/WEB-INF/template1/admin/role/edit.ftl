...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">${message("admin.main.supplierGroup")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:supplier"[#if role.authorities?seq_contains("admin:supplier")] checked="checked"[/#if] />${message("admin.main.supplier")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplierAttribute"[#if role.authorities?seq_contains("admin:supplierAttribute")] checked="checked"[/#if] />${message("admin.main.supplierAttribute")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplierAdmin"[#if role.authorities?seq_contains("admin:supplierAdmin")] checked="checked"[/#if] />${message("admin.main.supplierAdmin")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplierCompanySales"[#if role.authorities?seq_contains("admin:supplierCompanySales")] checked="checked"[/#if] />${message("admin.main.companySales")}
						</label>
					</span>
				</td>
			</tr>
