				...
				<div id="nav" class="nav">
					<ul>
						[#list ["admin:product", "admin:productCategory", "admin:parameterGroup", "admin:attribute", "admin:specification", "admin:brand", "admin:productNotify"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:supplier", "admin:supplierAttribute", "admin:supplierAdmin", "admin:supplierCompanySales"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
			...
			<td id="menu" class="menu">
				...
				<dl id="supplier">
					<dt>${message("admin.main.supplierGroup")}</dt>
						...
						[/@shiro.hasPermission]
						[@shiro.hasPermission name="admin:supplierAttribute"]
							<dd>
								<a href="../supplier_attribute/list.jhtml" target="iframe">${message("admin.main.supplierAttribute")}</a>
							</dd>
						[/@shiro.hasPermission]
						[@shiro.hasPermission name="admin:supplierAdmin"]
							<dd>
								<a href="../supplier/list_admin.jhtml" target="iframe">${message("admin.main.supplierAdmin")}</a>
							</dd>
						[/@shiro.hasPermission]
						[@shiro.hasPermission name="admin:supplierCompanySales"]
							<dd>
								<a href="../supplier/list_company_sales.jhtml" target="iframe">${message("admin.main.companySales")}</a>
							</dd>
						[/@shiro.hasPermission]
				</dl>	
				<dl id="order">
