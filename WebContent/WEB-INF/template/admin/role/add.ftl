		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:supplier" />${message("admin.main.supplier")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplierAttribute" />${message("admin.main.supplierAttribute")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplierAdmin" />${message("admin.main.supplierAdmin")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplierCompanySales" />${message("admin.main.companySales")}
						</label>
					</span>
				</td>
			</tr>
