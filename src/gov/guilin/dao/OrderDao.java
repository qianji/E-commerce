...
public interface OrderDao extends BaseDao<Order, Long> {
	 ...
	 * @return 订单
	 */
	List<Order> findList(Member member, Integer count, List<Filter> filters, List<gov.guilin.Order> orders);
	...
	Page<Order> findPage(OrderStatus orderStatus, PaymentStatus paymentStatus, ShippingStatus shippingStatus, Boolean hasExpired, Pageable pageable,Set<Supplier> suppliers);
