		...
		<table id="listTable" class="list">
			...
			[#list page.content as supplier]
				<tr>
					...
					<td>
						<a href="view_supplier_company.jhtml?id=${supplier.id}">[${message("admin.common.view")}]</a>
						<a href="edit_supplier_company.jhtml?id=${supplier.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
