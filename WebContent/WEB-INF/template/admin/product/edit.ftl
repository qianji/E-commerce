...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("Product.suppliers")}:
				</th>
				<td>
					<select name="supplierId">
						[#list suppliers as supplier]
							<option value="${supplier.id}"[#if supplier == product.supplier] selected="selected"[/#if]>
			...
			<tr>
				...
				<th>
					${message("admin.common.productType")}:
				</th>
				<td>
					<select name="productType">
						<option value="0" [#if product.productType == 0] selected="selected"[/#if]>
							${message("admin.common.productType.sms")}
						</option>
						<option value="1" [#if product.productType == 1] selected="selected"[/#if]>
							${message("admin.common.productType.idcard")}
						</option>
						<option value="2" [#if product.productType == 2] selected="selected"[/#if]>
							${message("admin.common.productType.shipping")}
						</option>
					</select>
				</td>
			<tr>
